...
export const workplacePage = [
  ...
  },
  {
    ...
    paragraph_main_one:
      'In January, I had occasion to support Repack Team during process of creating their MVP. With two weeks me and my team of developers from </salt> faced process of setting up the foundations of Repack cloud solution.',
    paragraph_main_two: '',
    img_me: `${w1Repack}`,
    header_goal: 'Goal of work',
    paragraph_goal_one: '',
